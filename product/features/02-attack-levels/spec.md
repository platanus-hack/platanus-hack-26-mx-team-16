...
Cada nivel define qué herramientas/intensidad usa **cada subagente**. Este documento cubre el subagente OWASP web; el subagente agéntico replica la escalera con su propia batería (ver [03-agentic-surface](../03-agentic-surface/spec.md)).
...
ejecutada dentro del **budget global de scan ~8 min** (con timeout duro por tool; ver [04-scanning-engine](../04-scanning-engine/spec.md)).
