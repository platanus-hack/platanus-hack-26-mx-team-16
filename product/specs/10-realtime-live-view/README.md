...
La definición de columnas de la tabla `scan_events` pertenece al modelo de datos; ver [06-data-model](../06-data-model/README.md).
...
El contrato HTTP completo del endpoint (parámetros, códigos, headers) lo define la capa de API; ver [12-api](../12-api/README.md).
...
- El callback del magic-link setea una **cookie HttpOnly** con `SameSite=Lax`. La emisión de esa cookie pertenece al flujo de magic-link; ver [11-auth-magic-link](../11-auth-magic-link/README.md).
