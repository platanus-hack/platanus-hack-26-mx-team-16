...
> [05-agent-team](../05-agent-team/README.md)), ni la forma del `Finding`
> (ver [06-data-model](../06-data-model/README.md)).
...
[08-ranking-watchlists](../08-ranking-watchlists/README.md) y la persistencia de
...
- Como las tool-functions devuelven `Finding[]` deterministas (parseo en Python,
  no en el LLM — ver [05-agent-team](../05-agent-team/README.md)), toda esta
...
pertenecen a [10-realtime-live-view](../10-realtime-live-view/README.md); aquí solo
...
[06-data-model](../06-data-model/README.md); aquí solo se fija dónde y cómo se
persiste el binario.)
...
> [05-agent-team](../05-agent-team/README.md); aquí solo aparecen en el
...
[02-attack-levels](../02-attack-levels/README.md) §7)—; el "avanzado" del demo es
...
conversación vive en [05-agent-team](../05-agent-team/README.md); aquí solo se
