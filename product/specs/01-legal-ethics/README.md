...
[13-frontend](../13-frontend/README.md). El enforcement a nivel de endpoint del gate
de atestación (validación de `authorized`/`authorized_at`/`requested_by` antes de
encolar en `POST /scans`) lo detalla [12-api](../12-api/README.md).
...
[08-ranking-watchlists](../08-ranking-watchlists/README.md); aquí queda fijado el invariante de
...
[08-ranking-watchlists](../08-ranking-watchlists/README.md) y [12-api](../12-api/README.md); el
...
[04-scanning-engine](../04-scanning-engine/README.md); esta capa fija el contrato
...
posee [12-api](../12-api/README.md); el detalle de los flags de rate-limit por
herramienta en el worker lo posee [04-scanning-engine](../04-scanning-engine/README.md).

## 5. Resumen del invariante

| Control | Dónde se aplica | Efecto |
|---|---|---|
| Atestación + consentimiento persistido (`authorized`, `authorized_at`, `requested_by`) | `POST /scans` (ver [12-api](../12-api/README.md)) | Sin atestación, no se encola activo |
