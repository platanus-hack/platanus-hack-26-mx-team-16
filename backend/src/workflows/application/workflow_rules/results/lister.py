"""List rule-evaluation results for a given analysis run."""
...
class WorkflowRuleResultsLister(UseCase):
    ...
    async def execute(self) -> list[WorkflowRuleResult]:
        ...
        return await self.result_repository.list_by_run(self.run_id, self.tenant_id)
