...
export function MethodologyBand() {
  return (
    <section
      ...
      className="mt-16 border-t border-outline-variant pt-12 md:mt-20"
    >
      <h2
        id="metodologia"
      ...
      <p className="mt-2 max-w-2xl text-sm leading-6 text-pretty text-on-surface-variant">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2">
        {DIMENSIONS.map((d) => (
          ...
          >
            ...
            <p className="text-sm leading-6 text-pretty text-on-surface-variant">
              {d.body}
            </p>
          </div>
        ))}
