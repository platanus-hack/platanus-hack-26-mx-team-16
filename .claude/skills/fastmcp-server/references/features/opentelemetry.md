...
The server creates spans for each operation using [MCP semantic conventions](https://opentelemetry.io/product/specs/semconv/gen-ai/mcp/):
...
Standard [RPC semantic conventions](https://opentelemetry.io/product/specs/semconv/rpc/rpc-spans/):
...
FastMCP implements the [OpenTelemetry MCP semantic conventions](https://opentelemetry.io/product/specs/semconv/gen-ai/mcp/):
...
Standard [identity attributes](https://opentelemetry.io/product/specs/semconv/attributes-registry/enduser/):
